...
public class productadapter2 extends RecyclerView.Adapter<productadapter2.ViewHolder> {
    ...
    public productadapter2(Context context, ArrayList<z_productmodel> data, String cat) {
    ...
    private void fav(productadapter2.ViewHolder holder, String id, z_productmodel data12) {
